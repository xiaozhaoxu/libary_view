package com.source.widget.edittextview;
...
//        	throw new NullPointerException("You can add drawableRight attribute in XML");
            mClearDrawable = getResources().getDrawable(R.drawable.edittext_clear_bg);
        }
    ...
    public boolean isShowClearBox() {
        return showClearBox;
    }

    public void setShowClearBox(boolean showClearBox) {
        this.showClearBox = showClearBox;
    }
